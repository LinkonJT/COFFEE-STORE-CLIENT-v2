...
/*****(5) start deleting the coffee order according to id */
...
.then(data=>{
    if(data.deletedCount){
        ...
        Swal.fire({
      title: "Deleted!",
      text: "Your coffe order has been deleted.",
      icon: "success"
    });
...
setCoffees(remainingCoffees);
  ...
  <Link to={`/coffee/${_id}`}><button coffee={coffee} className="btn join-item">View</button></Link>
